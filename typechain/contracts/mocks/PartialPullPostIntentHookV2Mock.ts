...
export interface PartialPullPostIntentHookV2MockInterface
...
export interface PartialPullPostIntentHookV2Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PartialPullPostIntentHookV2MockInterface;
