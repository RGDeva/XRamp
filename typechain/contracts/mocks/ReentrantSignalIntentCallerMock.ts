...
export interface ReentrantSignalIntentCallerMockInterface
  extends utils.Interface {
  functions: {
    "attemptReenter()": FunctionFragment;
    "orchestrator()": FunctionFragment;
    "setReentryParams((address,uint256,uint256,address,bytes32,bytes32,uint256,address,uint256,bytes,uint256,address,bytes))": FunctionFragment;
...
export interface ReentrantSignalIntentCallerMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReentrantSignalIntentCallerMockInterface;
