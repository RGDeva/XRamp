...
export interface PartialPullPostIntentHookMockInterface
...
export interface PartialPullPostIntentHookMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PartialPullPostIntentHookMockInterface;
