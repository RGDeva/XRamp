...
export interface PushPostIntentHookV2MockInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "execute" | "orchestrator" | "token"
  ): FunctionFragment;
...
export interface PushPostIntentHookV2Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PushPostIntentHookV2MockInterface;
  ...
  functions: {
    execute(
      arg0: IPostIntentHookV2.HookExecutionContextStruct,
