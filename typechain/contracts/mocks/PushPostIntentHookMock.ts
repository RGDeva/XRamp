...
export interface PushPostIntentHookMockInterface extends utils.Interface {
  functions: {
...
export interface PushPostIntentHookMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PushPostIntentHookMockInterface;
  ...
  functions: {
    execute(
      arg0: IOrchestrator.IntentStruct,
