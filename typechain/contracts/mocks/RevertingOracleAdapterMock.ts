...
export interface RevertingOracleAdapterMockInterface extends utils.Interface {
  functions: {
...
export interface RevertingOracleAdapterMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RevertingOracleAdapterMockInterface;
