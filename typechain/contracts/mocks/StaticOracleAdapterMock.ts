...
export interface StaticOracleAdapterMockInterface extends utils.Interface {
  functions: {
...
export interface StaticOracleAdapterMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StaticOracleAdapterMockInterface;
