...
export interface BaseUnifiedPaymentVerifierInterface extends utils.Interface {
  functions: {
...
export interface BaseUnifiedPaymentVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseUnifiedPaymentVerifierInterface;
