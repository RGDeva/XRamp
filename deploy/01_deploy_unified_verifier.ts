...
func.skip = async (hre: HardhatRuntimeEnvironment): Promise<boolean> => {
  ...
  // Allow fresh deployments on new networks that haven't deployed the verifier yet
  try {
    getDeployedContractAddress(network, "SimpleAttestationVerifier");
  } catch (e) {
    return false; // No existing deployment — deploy verifier
  }
