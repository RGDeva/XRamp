...
const config: HardhatUserConfig = {
    ...
    avalancheFuji: {
      ...
      verify: {
        etherscan: {
          ...
          apiKey: process.env.SNOWTRACE_API_KEY || "verifyContract",
        }
      },
    },
    /* goerli: {
  ...
  etherscan: {
    apiKey: {
      avalancheFuji: process.env.SNOWTRACE_API_KEY || "verifyContract",
    },
    customChains: [
      {
